...
<template>
  <div>
    ...
    <div class="navbar navbar-expand-sm navbar-light border-bottom justify-content-between">
      <a class="navbar-brand" href="/" role="heading" aria-level="1">Firstproject</a>
      <b-nav class="navbar-nav">
        <b-nav-item class="nav-item nav-link active" to="/">Home</b-nav-item>
        <b-nav-item class="nav-item nav-link active" to="/Master_Detail">Master_Detail</b-nav-item>
        <b-nav-item class="nav-item nav-link active" to="/Master_Detail1">Master_Detail1</b-nav-item>
        <b-nav-item class="nav-item nav-link active" to="/Master_Detail2">Master_Detail2</b-nav-item>
        <b-nav-item class="nav-item nav-link active" to="/Grid">Grid</b-nav-item>
        <b-nav-item class="nav-item nav-link active" to="/Grid1">Grid1</b-nav-item>
        <b-nav-item class="nav-item nav-link active" to="/List">List</b-nav-item>
        <b-nav-item class="nav-item nav-link active" to="/List1">List1</b-nav-item>
      </b-nav>
    </div>
  </div>
</template>
